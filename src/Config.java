...
public class Config {
  ...
  public static String getAllData() {
    ...
    try {
      ...
      while (resultData.next()) {
        data += "invoiceNumber : " + resultData.getInt("invoiceNumber") + "| customerName : "
            + resultData.getString("customerName") + "| NoHP : " + resultData.getString("NoHP") + "| alamat : "
            + resultData.getString("alamat") + "| itemName : " + resultData.getString("itemName") + "| price : "
            + resultData.getDouble("price") + "| quantity : " + resultData.getInt("quantity") + "\n";
      }
  ...
  public static boolean tambahData(String invoiceNumber, String customerName, String itemName, double price,
      int quantity, String NoHP, String alamat) {
    Config.connection();
    boolean data = false;
    ...
    try {
      ...
      String query = "INSERT INTO transaksi VALUES ('" + invoiceNumber + "', '" + customerName + "', '" + NoHP + "', '"
          + alamat + "', '" + itemName + "', " + price + ", " + quantity + ")";
  ...
  public static boolean updateData(int invoiceNumber, String itemName, int quantity, int price) {
    ...
    try {
      ...
      String queryUpdate = "UPDATE transaksi SET itemName = '" + itemCheck + "', quantity = " + stokCek + ", price = "
          + hargaCek + " WHERE invoiceNumber = " + invoiceNumber;
